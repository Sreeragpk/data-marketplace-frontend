...
const ForgotPassword = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-between bg-gray-100">
      ...
      <div className="w-1/2 flex items-center justify-center px-12 text-left">
        <div className="space-y-4 animate__animated animate__fadeInLeft">
          ...
          <p className="text-md text-gray-500">
            MicroLogic Data Marketplace keeps your data secure and your access easy.
          </p>
        </div>
      </div>
      ...
      <form
        ...
        className="z-10 w-full max-w-md p-10 bg-white rounded-2xl shadow-xl border border-gray-200 mr-16"
      >
